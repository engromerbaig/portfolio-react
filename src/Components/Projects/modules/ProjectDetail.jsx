...
const ProjectDetail = () => {
  return (
    <div className="flex flex-col md:flex-row p-10 items-center justify-center relative">
      ...
      {/* content container */}
      <div className="flex w-1/2 gap-10 flex-col items-start justify-center shadow-2xl rounded-lg p-8 bg-white relative md:-ml-20 z-10 hover:bg-slate-200 hover:shadow-lg transition duration-300">
