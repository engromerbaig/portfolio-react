export const jobProfiles = [
  {
    ...
    skills: ['WordPress', 'Elementor', 'Avada', 'SEO', 'Google Analytics'],
  ...
  },
  {
    ...
    skills: ['HTML5', 'CSS3', 'JavaScript', 'jQuery', 'WordPress', 'Elementor Pro', 'WooCommerce', 'Shopify', 'Wix', 'React'],
    languages: ['JavaScript', 'HTML', 'CSS'],
    projects: [
  ...
  },
  {
    ...
    skills: ['React.js', 'Vue.js', 'Redux', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'Bootstrap', 'Figma', 'Adobe XD'],
    languages: ['JavaScript', 'HTML', 'CSS'],
    projects: [
