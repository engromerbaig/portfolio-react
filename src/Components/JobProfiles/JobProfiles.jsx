      ...
      <div className="flex justify-center mb-4">
        {jobProfiles.map((profile, index) => (
          <button
            ...
            className={`px-4 py-2 border-2 mx-2 ${selectedTab === index ? 'bg-theme-blue text-white' : 'bg-light-hover dark:bg-dark-hover text-body-text-light dark:text-body-text-dark'}`}
          >
            {profile.title}
          </button>
        ))}
